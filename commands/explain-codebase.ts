...
async function explainCodebase(options: z.infer<typeof argsSchema>, context: ContainerContext) {
...
export default {
	description: 'Generate a codebase explainer document using Claude Code.',
	argsSchema,
	handler: explainCodebase,
}
