...
Runnable composition patterns — each combines multiple helpers and passes `luca test-examples`. For single-feature usage, use `luca describe <name>` (every helper carries per-method @example blocks).

- [Luca Assistant Example](./examples/assistant/CORE.md)
- [Assistant with Process Manager](./examples/assistant-with-process-manager.md)
- [Claude Controller Personas](./examples/claude-controller-personas.md)
- [Cross-Process State Handoff](./examples/cross-process-state-handoff.md)
- [Authoring a Custom Feature](./examples/custom-feature-authoring.md)
- [Daemon & Poll-Loop Commands](./examples/daemon-command.md)
- [Data Pipeline: fs + grep + sqlite](./examples/data-pipeline-fs-grep-sqlite.md)
- [Entity](./examples/entity.md)
- [Error Handling Conventions](./examples/error-handling-conventions.md)
- [Event Bus Fan-out](./examples/event-bus-fanout.md)
- [Feature as Tool Provider](./examples/feature-as-tool-provider.md)
- [A Full-Stack Slice: Endpoints, Express, and the REST Client](./examples/full-stack-slice.md)
- [Meta-Discovery: Plugin Registries](./examples/meta-discovery.md)
- [Semantic Search + Content DB](./examples/semantic-search-content-db.md)
- [WebSocket Server/Client Roundtrip](./examples/server-client-roundtrip-ws.md)
- [REST Server Roundtrip](./examples/server-rest-roundtrip.md)
- [SQLite Job Queue](./examples/sqlite-job-queue.md)
