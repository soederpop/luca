...
export const DEFAULT_ENV = [
	...
	'# When embeddings use the OpenAI-compatible provider, these override the',
	'# host / key / model just for embeddings (else fall back to OPENAI_BASE_URL',
	'# / OPENAI_API_KEY). Point at Ollama, vLLM, LiteLLM, or the OpenAI API.',
