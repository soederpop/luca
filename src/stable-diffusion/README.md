...
This interface assumes you have a checkout of automatic1111 stable diffusion webui

with the generate.py script 
...
This will let us use the proc feature to farm out the work to that script and just report state.
