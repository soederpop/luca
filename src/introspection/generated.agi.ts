...
// Generated at: 2026-03-15T01:57:18.117Z
...
setBuildTimeData('features.claudeCode', {
  ...
  "methods": {
    ...
    "sessionHistoryToMarkdown": {
      "description": "Export session history as a readable markdown document. Reads from a raw JSONL file (Claude CLI session log or this feature's NDJSON log) so it works independently of in-memory state. Can also accept a local session ID to export from in-memory state as a fallback.",
      "parameters": {
        "source": {
          "type": "string",
          "description": "Path to a JSONL file, a local session ID, or omit for the most recent session"
        }
      },
      "required": [],
      "returns": "Promise<string>",
  ...
  "getters": {
    ...
    "sessionId": {
      "description": "The Claude CLI session ID of the most recently initialized session, or the session set via the `session` option. Useful for resuming later.",
      "returns": "string | undefined",
      "examples": [
        {
          "language": "ts",
